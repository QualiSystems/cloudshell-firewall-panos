...
# ASN.1 source file://\Data\MIBS\text_mibs\paloalto\PAN-GLOBAL-REG
...
Integer32, NotificationType, Counter64, ObjectIdentity, ModuleIdentity, enterprises, TimeTicks, MibIdentifier, Gauge32, Bits, iso, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "ObjectIdentity", "ModuleIdentity", "enterprises", "TimeTicks", "MibIdentifier", "Gauge32", "Bits", "iso", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("PAN-GLOBAL-REG", PYSNMP_MODULE_ID=panGlobalRegModule, panRoot=panRoot, panReg=panReg, panSpecificMib=panSpecificMib, panGlobalRegModule=panGlobalRegModule, panProductsMibs=panProductsMibs, panCommonMib=panCommonMib, panModules=panModules, panMibs=panMibs)
